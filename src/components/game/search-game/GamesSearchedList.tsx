...
const GamesSearchedList = ({ games, loading, onClose }: gamesSearchedListProps) => {
  ...
  return (
    <div className="absolute z-[99] inset-0 m-auto p-4 overflow-hidden bg-black/70 backdrop-invert-[70%] mt-16 h-auto w-full overflow-y-scroll rounded-b-md" style={{ scrollbarWidth: 'none' }}>
      {loading ? (
            ...
            games.map(({ slug, name, background_image, parent_platforms }, index) => (
             ...
             <Image
                ...
                <div className="flex flex-col justify-center items-start overflow-hidden">
                  ...
                  <h5 className="whitespace-nowrap overflow-hidden text-ellipsis w-[14.5rem] md:w-full">{name}</h5>
                </div>
              </Link>
            )) : <p>No results</p>} 
